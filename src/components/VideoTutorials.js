            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center group-hover:bg-opacity-50 transition-all duration-300">
                  <div className="bg-primary bg-opacity-90 rounded-full p-3 group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="p-6">
                ...
                <a
                  ...
                  className="mt-4 inline-block text-primary font-medium text-sm hover:text-primary-dark transition-colors duration-300"
                >
                  Watch Video
                </a>
              </div>
